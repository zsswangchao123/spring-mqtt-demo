...
public class RoomMenageController {
    ...
    public Object removeUser(Long roomId, String userId) {
        try{
            // 实例化一个认证对象，入参需要传入腾讯云账户 SecretId 和 SecretKey，此处还需注意密钥对的保密
            // 代码泄露可能会导致 SecretId 和 SecretKey 泄露，并威胁账号下所有资源的安全性。以下代码示例仅供参考，建议采用更安全的方式来使用密钥，请参见：https://cloud.tencent.com/document/product/1278/85305
            // 密钥可前往官网控制台 https://console.cloud.tencent.com/cam/capi 进行获取
            Credential cred = new Credential("AKIDxqbQ6f3NacaP6iBUeeUB4oNoJfu0ymNj", "DE0Xrw0wieM3e8Wt8BzZzEG6kEl8JG5j");
            ...
            req.setSdkAppId(1600010428L);
            req.setUserIds(new String[]{userId});

            // 返回的resp是一个RemoveUserResponse的实例，与请求对象对应
            RemoveUserResponse resp = client.RemoveUser(req);
            // 输出json格式的字符串回包
            System.out.println(RemoveUserResponse.toJsonString(resp));
